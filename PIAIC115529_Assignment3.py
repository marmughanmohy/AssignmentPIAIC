...
def function3():
    ...
    x= a[(np.remainder(a,5)==0)&(np.remainder(a,7)==0)] #wrtie your code here
    return x
    """
    Expected Output:
...
def function6():
    ...
    arr = np.zeros(10);z[4]=10;z[7]=20 #wrtie your code here
...
def function8():
    ...
    x =  np.ones(10,dtype='uint32').reshape(2,5) *6 #write your code here
...
def function9():
    ...
    a = np.arange(1,51)*2 # write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt =arr.swapaxes(1,0)-brr  # write your code here 
...
def function11():
    ...
    ans = arr;ans[ans % 2 == 1]=-1 #write your code here 
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans =np.hstack((np.hstack(np.hstack((np.vstack(arr),np.vstack(arr),np.vstack(arr)))),np.hstack((arr,arr,arr)))) #write your code here 
...
def function14():
    ...
    ans = np.split(np.reshape(arr,(8,3)),4)#write your code here 
...
def function18():
    ...
    x = np.sum(np.isin(piaic, students))# Write you code Here
    return x
...
def function19():
    ...
    X = np.arange(1,26,1).reshape(5,5)  # Write your code here
    W =  x.T # Write your code here 
    b = np.ones(w.shape)*5  # Write your code here
